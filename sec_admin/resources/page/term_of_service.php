	...
	<div class="orders">
		<div class="row">
			<div class="col-xl-12">
				<div class="card">
					<div class="card-body">
						<h4 class="box-title">Edit Term of Service Content <div class="float-right"><a href="../terms_of_service.php" target="_blank" class="btn-sm btn-primary"><i class="fa fa-eye"></i> View</a></div></h4>
					</div>
